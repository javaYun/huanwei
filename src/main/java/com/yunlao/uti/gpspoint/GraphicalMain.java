...
public class GraphicalMain {
	public static void main(String[] args) {
		...
		Area a4=new Area(113.941853,22.530777);
		Area a2=new Area(113.94788,22.527597);
		Area a3=new Area(113.940487,22.527789);
		Area a1=new Area(113.947925,22.530618);
		List<Area> areas=new ArrayList<Area>();
		areas.add(a1);
		areas.add(a2);
		areas.add(a3);
		areas.add(a4);
//		System.out.println(isPointInPolygon(113.947871,22.52804,areas));
		System.out.println(isPointInPolygon(113.941887,22.527989, areas));
