...
@Controller
public class VerifyCodeController extends HttpServlet {//VerifyCodeServlet
  // 验证码图片的宽度。         
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)         
        ...
        String yy = veryCode.toLowerCase();//全部转为小写
        String ss = veryCode.toUpperCase();//全部转为大写
        if(ss==null||"".equals(ss)){         
            out.println("验证码为空");         
        }else{         
            if(validateC.equals(ss)){         
                out.println("验证码正确");         
            }else{     
                out.println("验证码错误");         
            }         
