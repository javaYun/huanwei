package com.sczh.platform.service.redis;
...
import com.yunlao.util.Redis.JsonUtils;
...
//		redisTemplate.opsForValue().get
		...
		return redisTemplate.opsForValue().get(key, 0, 10);
	}
	
	@Override
	public List<String> getList(String key, int startNum, int endNum) {
		return redisTemplate.opsForList().range(key, startNum, endNum);
	}
