...
public class DailyPageDomain  {
     ...
     * content 每页的内容
     */
    private List<DailyTaskInfo> content;
	public int getId() {
		return id;
	}
	...
	public List<DailyTaskInfo> getContent() {
		return content;
	}
	public void setContent(List<DailyTaskInfo> content) {
		this.content = content;
	}
	@Override
	public String toString() {
		return "DailyPageDomain [id=" + id + ", pageSize=" + pageSize
