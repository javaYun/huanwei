...
public class TrashCleanPageDomain  {
     ...
     * content 每页的内容
     */
    private List<LjflClean> content;
	public int getId() {
		return id;
	}
	...
	public List<LjflClean> getContent() {
		return content;
	}
	public void setContent(List<LjflClean> content) {
	...
	public String toString() {
		return "TrashCleanPageDomain [time=" + time + ", id=" + id
