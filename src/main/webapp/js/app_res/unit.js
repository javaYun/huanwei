function joinUnitPage(){
	hideContent();
	$("#top").html(displayButton("驾驶员登记","驾驶员信息修改","删除驾驶员数据","返回首页","7"));
	var shouyeUrl = "<iframe id='addIframe' src='/CDS/cds/joinDriverPage?' style='width:100%;height:464px;border:0;margin-top:55px;margin-left:20px;scrolling:no'></iframe>";
	$("#top").show();
...
function deleteDriver(){ //jquery获取复选框值 
	...
	function updateCarInfo(){
		...
		if(chk_value.length>1){
			...
			var shouyeUrl = "<iframe src='/SczhPlatform/sczhCarController/updateCarInfopage?&id="+carId+"'  style='width:100%;height:464px;border:0;margin-top:55px;margin-left:20px;scrolling:no'></iframe>";
