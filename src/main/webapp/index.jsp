...
<div data-toggle="topjui-layout" data-options="id:'index_layout',fit:true">
    <div id="north" class="banner" data-options="region:'north',border:false,split:false"
        ...
        <table style="float:left;border-spacing:0px;">
            <tr>
                <td class="webname">
                    <span class="fa fa-envira" style="font-size:26px; padding-right:8px;"></span>环卫一体化系统
                </td>
                ...
                <td>
					...
					<!--<table data-toggle="topjui-datagrid"
						data-options="id:'',
						url:'http://localhost:8080/CDS/user/userinfo',
						filter: [{
							field: 'userName',
							type: 'textbox',
				...
				<tr>
					...
					<td data-options="field:'username',sortable:true"></th>
					<td data-options="field:'authority',sortable:true"></th>
               
				</tr>
            </thead>
        </table>-->
					
                        <td id="" title="首页" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa fa-hand-pointer-o"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">首页</span></p>
                            </a>
                        </td>

                        <td id="10" title="基本信息" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa fa-hand-pointer-o"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">基本信息</span></p>
                            </a>
                        </td>

                        <td id="20" title="日常调度" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa fa-hand-pointer-o"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">日常调度</span></p>
                            </a>
                        </td>

						<td id="30" title="组织机构" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa fa-puzzle-piece"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">组织机构</span></p>
                            </a>
                        </td>

                        <td id="40" title="车辆管理" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa fa-hand-pointer-o"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">车辆管理</span></p>
                            </a>
                        </td>

                        <td id="50" title="厨余管理" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa fa-hand-pointer-o"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">厨余管理</span></p>
                            </a>
                        </td>
                        <td id="60" title="积分管理" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa fa-hand-pointer-o"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">积分管理</span></p>
                            </a>
                        </td>

                        <td id="70" title="合同管理" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa fa-hand-pointer-o"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">合同管理</span></p>
                            </a>
                        </td>
                        <td id="80" title="投放回收子系统" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa fa-hand-pointer-o"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">投放回收子系统</span></p>
                            </a>
                        </td>
                    </table>
                </td>
        ...
        <span style="float: right; padding-right: 10px; height: 50px; line-height: 50px;">
			<a href="#" class="topjui-linkbutton" data-options="plain:true" style="color:#fff;">首创危废</a>
			<a id="btn-edit" href="#" class="topjui-menubutton" data-options="menu:'#mm3',iconCls:'icon-edit'" style="color:#fff;">设置</a>
            <div id="mm3" style="width:74px;">
           	...
           	<a href="#" class="topjui-menubutton" data-options="menu:'#mm2',iconCls:'icon-help'" style="color:#fff;">主题</a>
    ...
    <div id="center" data-options="region:'center',border:false" style="overflow:hidden;">
        <div id="index_tabs" style="width:100%;height:100%">
            ...
            content:'<iframe id=\'shouye\' src=\'./html/homepage/shouye_10.html\' scrolling=\'auto\' frameborder=\'0\' style=\'width:100%;height:100%;\'></iframe>'"></div>
        </div>
    </div>
    ...
    <div data-options="region:'south',border:true"
        ...
        <span style="padding-right:5px;width:40%">
            版权所有
            <a href="http://www.ewsd.cn" target="_blank">北京首创智慧环卫发展有限公司</a>
